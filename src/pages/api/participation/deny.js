  ...
  if (req.method === 'GET') {
    ...
    try {
      ...
      const HtmlBody = `
        ...
        <p>Je inschrijving bij leerkans '${participation.Opportunity.title}' is geweigerd.</p>
      ...
      const TextBody = `
        ...
        Je inschrijving bij leerkans '${participation.Opportunity.title}' is geweigerd.
      ...
      await postmarkClient.sendEmail({
        ...
        To: email,
        Subject: 'Inschrijving geweigerd',
        HtmlBody,
        TextBody,
